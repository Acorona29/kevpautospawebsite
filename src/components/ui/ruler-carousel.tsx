...
export function RulerCarousel({
  ...
  // Start with the middle set, item 4 (center item)
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-white px-4">
      <div className="w-full max-w-4xl h-[200px] flex flex-col justify-center relative">
        <div className="flex items-center justify-center">
          <RulerLines top />
        </div>
        <div className="flex items-center justify-center w-full h-full relative overflow-hidden">
          <motion.div
            className="flex items-center gap-[50px] sm:gap-[100px]"
            animate={{
            ...
            {infiniteItems.map((item, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`text-lg sm:text-2xl md:text-4xl lg:text-5xl font-bold whitespace-nowrap cursor-pointer flex items-center justify-center ${
                    isActive
                      ? "text-black"
